...
from techbrain.api.routes.documents import router as documents_router
...
from techbrain.api.routes.overview import router as overview_router
...
api_router.include_router(
    overview_router, prefix="/knowledge/overview", tags=["knowledge-overview"]
)
